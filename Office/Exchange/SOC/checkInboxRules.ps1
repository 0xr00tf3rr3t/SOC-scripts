...
Get-InboxRule -Mailbox $mailbox -IncludeHidden | Select-Object @{Name="Mailbox";Expression={$mailbox}}, Name, Description  | Export-Csv -Path "./${mailbox}-MailboxRules.csv" -NoTypeInformation -Append 
